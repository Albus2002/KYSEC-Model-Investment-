...
model = MLPMixer(478,1)

model.load_state_dict(torch.load('../model_0327_Mixer/model_best_3_r2_-0.002123145623857088.pth'))
model.to(device)
...
print(len(all_outputs),len(test_label))
