...
train_data = StockDataset(train_pth,feature_columns,target_column,is_train = 1)
test_data = StockDataset(test_pth,feature_columns,target_column,scaler = train_data.scaler,is_train = 0)

test_data.save_data('test2')
