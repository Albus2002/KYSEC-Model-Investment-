from data_loader_h5 import StockDataset
# 假设你有一个文件列表
file_list = ['/mnt/tmpdata/lvhanglong/data_20240312/df_facs_train.h5']
...
# 创建数据集
dataset = StockDataset(file_list, feature_columns, target_column)
for i in range(5):
    print(111)
    idx = 0
    dataset.__getitem__(idx=idx)
    print(2222)
